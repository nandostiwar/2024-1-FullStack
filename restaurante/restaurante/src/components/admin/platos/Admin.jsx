    ...
    <>
      ...
      <div className="container">
        ...
        <form onSubmit={handleSubmit} className="form-platos">
          ...
          <button type="submit" className="btn-crear-plato">Guardar</button>
        </form>
          ...
          <tbody>
            {platos.map((plato, index) => (
              <tr key={index}>
                ...
                <td>
                  <a className="btn-editar"><i onClick={() => handleEdit(index)} className="editar fas fa-edit fa-lg"><i onClick={() => handleDelete(plato.plato_id)} className="eliminar fas fa-trash-alt fa-sm"></i></i></a>
                </td>
              </tr>
            ))}
          </tbody>
